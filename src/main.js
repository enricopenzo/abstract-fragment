...
import * as THREE from 'three';
		...
		function init() {
			...
			camera = new THREE.PerspectiveCamera( 45, window.innerWidth / canvasH, 1, 10000 );
		...
		function onWindowResize() {
			...
			camera.aspect = window.innerWidth / canvasH;
		...
		function generateMaterials() {
			...
			const path = 'https://localhost:3000/textures/cube/SwedishRoyalCastle/';
			const format = '.jpg';
			const urls = [
			...
			const texture = new THREE.TextureLoader().load( 'https://localhost:3000/textures/uv_grid_opengl.jpg' );
...
*/
		...
		function updateCubes( object, time, numblobs, floor, wallx, wallz ) {
			...
			const rainbow = [
				...
				new THREE.Color( 0x373f50 ),
				new THREE.Color( 0x818395 ),
				new THREE.Color( 0x32393e ),
				new THREE.Color( 0x1a3138 ),
				new THREE.Color( 0x6c635b ),
				new THREE.Color( 0x2a393e )
			];
			const subtract = 12;
